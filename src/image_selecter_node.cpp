...
ImageSelecterGUI::ImageSelecterGUI(QWidget *parent) : QWidget(parent), shutdown_required(false), thread(&ImageSelecterGUI::spin, this) {
  ...
  radioButtonCharge = new QRadioButton("Charge");
  radioButtonCurrent = new QRadioButton("Current");
  radioButtonAsIs = new QRadioButton("As Is");
  radioButtonAsIs->setChecked(true);
  ...
  // Charge Current 'As Is' QhBox
  qhBoxChargeCurrentAsIs = new QHBoxLayout;
  qhBoxChargeCurrentAsIs->addWidget(radioButtonCharge);
  qhBoxChargeCurrentAsIs->addWidget(radioButtonCurrent);
  qhBoxChargeCurrentAsIs->addWidget(radioButtonAsIs);
  groupBoxChargeCurrentAsIs = new QGroupBox(this);
  groupBoxChargeCurrentAsIs->setLayout(qhBoxChargeCurrentAsIs);
  groupBoxChargeCurrentAsIs->setSizePolicy(sizePolicy);

  // Image Video QhBox
  qhBoxImageVideo = new QHBoxLayout;
  qhBoxImageVideo->addWidget(radioButtonImage);
  qhBoxImageVideo->addWidget(radioButtonVideo);
  groupBoxImageVideo = new QGroupBox(this);
  groupBoxImageVideo->setLayout(qhBoxImageVideo);
  groupBoxImageVideo->setSizePolicy(sizePolicy);

  // Common QhBox
  qhBoxCommon = new QHBoxLayout;
  qhBoxCommon->addWidget(groupBoxChargeCurrentAsIs);
  qhBoxCommon->addWidget(groupBoxImageVideo);
...
ImageSelecterGUI::~ImageSelecterGUI() {
  ...
  delete qhBoxImageVideo;
  delete radioButtonAsIs;
  delete radioButtonCharge;
  delete radioButtonCurrent;
  delete qhBoxChargeCurrentAsIs;
  delete qhBoxCommon;
...
void ImageSelecterGUI::publishImage() {
  ...
  } else if (radioButtonCharge->isChecked())
  {
    cvImage.header.frame_id = "charge";
    ROS_INFO("[%s] Send as charge", ros::this_node::getName().c_str());
  }else if (radioButtonAsIs->isChecked())
  {
    cvImage.header.frame_id = "asis";
    ROS_INFO("[%s] Send as is", ros::this_node::getName().c_str());
  }
