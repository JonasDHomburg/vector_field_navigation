...
private:
  ...
  QGroupBox *groupBoxChargeCurrentAsIs;
  QHBoxLayout *qhBoxChargeCurrentAsIs;
  QRadioButton *radioButtonCharge;
  QRadioButton *radioButtonCurrent;
  QRadioButton *radioButtonAsIs;

  QGroupBox *groupBoxImageVideo;
  QHBoxLayout *qhBoxImageVideo;
